...
Funcion datoCaracter = capturarDatoChar(mensaje)
	...
	Leer datoCaracter
FinFuncion
SubAlgoritmo registrarUsuario(nombres,10,mensaje,nombreUsuario)
	Definir auxNombres Como Caracter
	Definir  i Como Entero
	//nombres(1)=Mayusculas("Miguel")
	//nombres(2)=Mayusculas("Aura")
	//nombres(3)=Mayusculas("Jose")
	//nombres(4)=mayusculas("Lorena")
	//nombres(5)=Mayusculas("Pedro")
	//nombres(6)=Mayusculas("Carlos")
	//nombres(7)=Mayusculas("Cecilia")
	//nombres(8)=Mayusculas("Juan")
	//nombres(9)=Mayusculas("Maria")
	...
	Repetir
		...
		Repetir
			Para i=1 Hasta 10 Hacer
				Leer auxNombres
				si Mayusculas(auxNombres)=nombres(i)
					Mostrar "El nombre de ususario ya exite"
				FinSi
				
				si auxNombres<>nombres(i)
					nombreUsuario=auxNombres
				FinSi
				
			FinPara
			//i=i+1
		Hasta Que auxNombres<>nombres(i) 
...
Algoritmo sin_titulo
	...
	para j=1 Hasta 10 Hacer
		nombres(j)=""
	FinPara
	registrarUsuario(nombres,10,"Ingrse un nombre de usuario",nombreUsuario)
	Mostrar "Elnombre " nombreUsuario
